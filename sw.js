 ...
 */
const CACHE_NAME = 'hyperkernel-v114';
const PRECACHE = [
  '/',
  '/index.html',
  '/manifest.json',
  ...
  '/css/decision-inbox.css',
  '/css/approval-inbox.css',
  '/css/workforce.css',
  '/css/visual-evidence.css',
  '/css/decision-bundle.css',
  ...
  '/js/core/aaa-policy-contract.js',
  '/js/core/aaa-policy-decision.js',
  ...
  '/js/intelligence/visual-memory-store.js',
  '/js/intelligence/ad-attribution.js',
  '/js/intelligence/telemetry-seal.js',
  ...
  '/js/ui/decision-bundle-ui.js',
  '/js/ui/decision-inbox-ui.js',
  '/js/ui/approval-inbox-ui.js',
  '/js/ui/workforce-ui.js',
  '/js/ui/agent-command-ui.js',
  '/js/ui/visual-evidence-ui.js',
