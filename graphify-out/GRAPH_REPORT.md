...
## Corpus Check
- Large corpus: 627 files · ~526,504 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 4967 nodes · 9684 edges · 364 communities (325 shown, 39 thin omitted)
...
- [[_COMMUNITY_Unit Governance Learning|Unit Governance Learning]]
- [[_COMMUNITY_Sw|Sw]]
...
1. `makeRunner()` - 140 edges
2. `setupEnv()` - 137 edges
3. `load()` - 132 edges
4. `render()` - 30 edges
5. `read()` - 24 edges
6. `U()` - 17 edges
...
### Community 4 - "Unit Governance Sync"
Cohesion: 0.04
Nodes (22): makeRunner(), { makeRunner }, { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load }, { makeRunner }, { makeRunner, setupEnv, load } (+14 more)
...
### Community 6 - "Transport Transport Core"
Cohesion: 0.13
...
### Community 118 - "Crew Crew Store"
Cohesion: 0.32
Nodes (14): add(), cfg(), clock(), data(), get(), ids(), list(), mine() (+6 more)

### Community 119 - "Portal Proxy Test"
Cohesion: 0.19
...
### Community 249 - "Functions Index"
Cohesion: 0.33
Nodes (5): ANTHROPIC_API_KEY, { defineSecret }, nemo, NVIDIA_API_KEY, { onRequest }

### Community 252 - "Functions Transport Webhook"
Cohesion: 0.47
Nodes (4): config, json(), normTwilio(), parse()

### Community 253 - "Governance Governance Bridge"
Cohesion: 0.60
Nodes (5): attach(), events(), init(), measure(), reg()

### Community 254 - "Intelligence Resource Allocator"
Cohesion: 0.67
Nodes (5): allocateDetailed(), allocateResourcesForGoal(), distance(), goalEngine(), num()

### Community 255 - "Revenue Revenue Dashboard"
Cohesion: 0.67
Nodes (5): clock(), nowISO(), nowMs(), sig(), view()

### Community 256 - "Revenue Timing Engine"
Cohesion: 0.47
Nodes (4): bestWindow(), data(), list(), topIndex()

### Community 258 - "Simulation Strategy Scorecard"
Cohesion: 0.47
Nodes (3): dashboard(), governance(), ledger()

### Community 259 - "Test Run Rules"
Cohesion: 0.33
Nodes (5): cp, dir, fs, path, r

### Community 260 - "Hermes Console"
Cohesion: 0.60
Nodes (5): bubble(), esc(), hermes(), render(), U()

### Community 261 - "Unit Agent Council"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 262 - "Unit Agent Evaluation"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 263 - "Unit Ai Operations"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 264 - "Unit Business Digital"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 265 - "Unit Calibration"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 266 - "Unit Event Stream"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 267 - "Unit Executive Council"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 268 - "Unit Financial Intelligence"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 269 - "Unit Goal Capability"
Cohesion: 0.33
Nodes (4): CURRENT, GOAL, { makeRunner, setupEnv, load }, MOCK

### Community 270 - "Unit Governance Registry"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 271 - "Unit Knowledge Os"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 272 - "Unit Learning Fabric"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 273 - "Unit Learning Feedback"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 274 - "Unit Model Governance"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 275 - "Unit Native Model"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 276 - "Unit Outcome Intelligence"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 277 - "Unit Owner Copilot"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 278 - "Unit Privacy Dashboard"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 279 - "Unit Proposal Review"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 280 - "Unit Provenance"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 281 - "Unit Reliability"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 282 - "Unit Replay Sandbox"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 283 - "Unit Security"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 284 - "Unit Sensing"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 285 - "Unit Teleological Test"
Cohesion: 0.33
Nodes (3): CURRENT, GOAL, { makeRunner, setupEnv, load }

### Community 286 - "Unit Transport Dashboard"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 287 - "Unit Transport Inbox"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 288 - "Unit Vector Memory"
Cohesion: 0.40
Nodes (3): fakeUI(), loadAll(), { makeRunner, setupEnv, load }

### Community 289 - "Icons Icon 192"
Cohesion: 0.50
...
### Community 290 - "Ai Sidekick Closure"
Cohesion: 0.80
Nodes (4): auditJobFile(), photoEvidence(), verifyPhotos(), verifySyncStatus()

### Community 291 - "Ai Sidekick Vision"
Cohesion: 0.70
Nodes (4): analyzeCarpetDamage(), captureAndAnalyze(), fileToBase64(), visionEndpoint()

### Community 292 - "Copilot Copilot Dashboard"
Cohesion: 0.70
Nodes (4): clock(), nowISO(), safe(), view()

### Community 293 - "Copilot Copilot Memory"
Cohesion: 0.70
Nodes (4): beliefs(), fabric(), retrieve(), tokens()

### Community 294 - "Copilot Copilot Simulation"
Cohesion: 0.70
Nodes (4): num(), parse(), run(), runner()

### Community 295 - "Copilot Council Query"
Cohesion: 0.70
Nodes (4): clock(), nowMs(), query(), safe()

### Community 296 - "Copilot Voice Input"
Cohesion: 0.70
Nodes (4): isSupported(), listen(), mode(), SR()

### Community 298 - "Data Eval Golden"
Cohesion: 0.40
Nodes (4): cases, _comment, synthetic, version

### Community 299 - "Functions Transport Send"
Cohesion: 0.60
Nodes (4): config, json(), sendEmail(), sendSms()

### Community 300 - "Genesis Capability Roi"
Cohesion: 0.70
Nodes (3): compute(), leaderboard(), ledger()

### Community 301 - "Governance Governance Integrity"
Cohesion: 0.70
Nodes (4): check(), escalation(), ledger(), selfAudit()

### Community 307 - "Test Package"
Cohesion: 0.40
Nodes (4): description, name, private, type

### Community 308 - "Governance Badge"
Cohesion: 0.70
Nodes (4): esc(), openDrawer(), reg(), ui()

### Community 311 - "Unit Capability Economy"
Cohesion: 0.40
Nodes (3): BADOUT, GOOD, { makeRunner, setupEnv, load }

### Community 312 - "Unit Copilot Test"
Cohesion: 0.50
Nodes (3): iso(), { makeRunner, setupEnv, load }, seed()

### Community 315 - "Unit Innovation Council"
Cohesion: 0.50
Nodes (3): iso(), { makeRunner, setupEnv, load }, seed()

### Community 317 - "Unit Outcome Learning"
Cohesion: 0.50
Nodes (4): BASE, iso(), { makeRunner, setupEnv, load }, seed()

### Community 318 - "Unit Pricing Optimizer"
Cohesion: 0.50
Nodes (4): BASE, iso(), { makeRunner, setupEnv, load }, seed()

### Community 320 - "Unit Revenue Council"
Cohesion: 0.50
Nodes (3): iso(), { makeRunner, setupEnv, load }, seed()

### Community 322 - "Agents Marketing Intel"
Cohesion: 0.83
Nodes (3): channelStats(), data(), review()

### Community 324 - "Copilot Copilot Governance"
Cohesion: 0.83
Nodes (3): classify(), gate(), governance()

### Community 325 - "Copilot Sms Response"
Cohesion: 0.83
Nodes (3): cap(), format(), num()

### Community 327 - "Genesis Agent Template"
Cohesion: 0.83
Nodes (3): typeOf(), validate(), validateAgainst()

### Community 328 - "Innovation Innovation Dashboard"
Cohesion: 0.83
Nodes (3): clock(), nowISO(), view()

### Community 332 - "Revenue Budget Physics"
Cohesion: 0.83
Nodes (3): allocate(), marketing(), num()

### Community 333 - "Revenue Followup Intelligence"
Cohesion: 0.83
Nodes (3): sequence(), silence(), timing()

### Community 334 - "Revenue Objection Forecast"
Cohesion: 0.83
Nodes (3): forecast(), num(), trust()

### Community 346 - "Hyperkernel Five Primitives"
Cohesion: 0.67
...
## Knowledge Gaps
- **416 isolated node(s):** `root`, `browser`, `es2022`, `ecmaVersion`, `sourceType` (+411 more)
...
- **Why does `makeRunner()` connect `Unit Governance Sync` to `Unit Audit Ledger`, `Unit Agent Council`, `Unit Agent Evaluation`, `Unit Ai Operations`, `Unit Business Digital`, `Unit Bluetooth Connect`, `Unit Calibration`, `Unit Event Stream`, `Unit Executive Council`, `Unit Financial Intelligence`, `Unit Goal Capability`, `Unit Governance Registry`, `Unit Knowledge Os`, `Unit Learning Fabric`, `Unit Learning Feedback`, `Unit Model Governance`, `Unit Native Model`, `Unit Outcome Intelligence`, `Unit Owner Copilot`, `Unit Privacy Dashboard`, `Unit Proposal Review`, `Unit Provenance`, `Unit Reliability`, `Unit Replay Sandbox`, `Unit Security`, `Unit Sensing`, `Unit Teleological Test`, `Unit Transport Dashboard`, `Unit Transport Inbox`, `Unit Vector Memory`, `Unit Capability Economy`, `Unit Copilot Test`, `Unit Estimator`, `Unit Financial Intelligence`, `Unit Innovation Council`, `Unit Legal War`, `Unit Outcome Learning`, `Unit Pricing Optimizer`, `Unit Quote Lifecycle`, `Unit Revenue Council`, `Unit Sms Copilot`, `Unit Calibration Runtime`, `Unit Content Safety`, `Unit Governance Bridge`, `Unit Hermes Gateway`, `Unit Prediction Closure`, `Unit Simulation Council`, `Unit World Model`, `Unit Governance Learning`, `Unit Pricing Optimizer`, `Unit Assisted Drafts`, `Unit Quote Win`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `setupEnv()` connect `Unit Audit Ledger` to `Unit Governance Sync`, `Unit Agent Council`, `Unit Agent Evaluation`, `Unit Ai Operations`, `Unit Business Digital`, `Unit Calibration`, `Unit Bluetooth Connect`, `Unit Event Stream`, `Unit Executive Council`, `Unit Financial Intelligence`, `Unit Goal Capability`, `Unit Governance Registry`, `Unit Knowledge Os`, `Unit Learning Fabric`, `Unit Learning Feedback`, `Unit Model Governance`, `Unit Native Model`, `Unit Outcome Intelligence`, `Unit Owner Copilot`, `Unit Privacy Dashboard`, `Unit Proposal Review`, `Unit Provenance`, `Unit Reliability`, `Unit Replay Sandbox`, `Unit Security`, `Unit Sensing`, `Unit Teleological Test`, `Unit Transport Dashboard`, `Unit Transport Inbox`, `Unit Vector Memory`, `Unit Capability Economy`, `Unit Copilot Test`, `Unit Estimator`, `Unit Financial Intelligence`, `Unit Innovation Council`, `Unit Legal War`, `Unit Outcome Learning`, `Unit Pricing Optimizer`, `Unit Quote Lifecycle`, `Unit Revenue Council`, `Unit Sms Copilot`, `Core Rbac`, `Unit Calibration Runtime`, `Unit Content Safety`, `Unit Governance Bridge`, `Unit Hermes Gateway`, `Unit Prediction Closure`, `Unit Simulation Council`, `Unit World Model`, `Unit Governance Learning`, `Unit Pricing Optimizer`, `Unit Assisted Drafts`, `Unit Quote Win`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `load()` connect `Unit Audit Ledger` to `Unit Governance Sync`, `Unit Agent Council`, `Unit Agent Evaluation`, `Unit Ai Operations`, `Unit Business Digital`, `Unit Calibration`, `Unit Bluetooth Connect`, `Unit Event Stream`, `Unit Executive Council`, `Unit Financial Intelligence`, `Unit Goal Capability`, `Unit Governance Registry`, `Unit Knowledge Os`, `Unit Learning Fabric`, `Unit Learning Feedback`, `Unit Model Governance`, `Unit Native Model`, `Unit Outcome Intelligence`, `Unit Owner Copilot`, `Unit Privacy Dashboard`, `Unit Proposal Review`, `Unit Provenance`, `Unit Reliability`, `Unit Replay Sandbox`, `Unit Security`, `Unit Sensing`, `Unit Teleological Test`, `Unit Transport Dashboard`, `Unit Transport Inbox`, `Unit Vector Memory`, `Unit Capability Economy`, `Unit Copilot Test`, `Unit Estimator`, `Unit Financial Intelligence`, `Unit Innovation Council`, `Unit Legal War`, `Unit Outcome Learning`, `Unit Pricing Optimizer`, `Unit Quote Lifecycle`, `Unit Revenue Council`, `Unit Sms Copilot`, `Core Rbac`, `Unit Calibration Runtime`, `Unit Content Safety`, `Unit Governance Bridge`, `Unit Hermes Gateway`, `Unit Prediction Closure`, `Unit Simulation Council`, `Unit World Model`, `Unit Governance Learning`, `Unit Pricing Optimizer`, `Unit Assisted Drafts`, `Unit Quote Win`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
...
- **Should `Unit Audit Ledger` be split into smaller, more focused modules?**
  _Cohesion score 0.025318847425602267 - nodes in this community are weakly interconnected._
