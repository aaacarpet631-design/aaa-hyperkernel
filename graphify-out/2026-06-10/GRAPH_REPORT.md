...
## Summary
- 7459 nodes · 13178 edges · 587 communities (528 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0229c1e5`
...
## Communities (587 total, 59 thin omitted)

### Community 0 - "Unit Audit Ledger"
Cohesion: 0.02
Nodes (75): load(), makeClock(), makeConfig(), makeData(), makeEvents(), makeIds(), path, setupEnv() (+67 more)
...
Cohesion: 0.04
Nodes (26): makeRunner(), { makeRunner }, installDom(), makeEl(), { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load }, { makeRunner, setupEnv, load } (+18 more)
...
## Knowledge Gaps
- **1580 isolated node(s):** `session-start.sh script`, `$schema`, `name`, `name`, `url` (+1575 more)
...
- **Should `Unit Audit Ledger` be split into smaller, more focused modules?**
  _Cohesion score 0.023762861342479177 - nodes in this community are weakly interconnected._
