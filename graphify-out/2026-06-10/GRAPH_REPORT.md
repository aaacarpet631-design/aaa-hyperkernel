...
## Corpus Check
- 686 files · ~584,320 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7438 nodes · 13137 edges · 589 communities (526 shown, 63 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08f7e03d`
...
1. `makeRunner()` - 157 edges
2. `setupEnv()` - 154 edges
3. `load()` - 149 edges
4. `render()` - 30 edges
...
## Communities (589 total, 63 thin omitted)
...
Cohesion: 0.38
Nodes (10): actionLabelFor(), esc(), fmtMoney(), mount(), num(), openDecision(), openSupervisor(), openTeam() (+2 more)

### Community 367 - "Unit Prediction Closure"
Cohesion: 0.22
Nodes (20): bodyFor(), buildCardFromScored(), buildFollowUpDecision(), bus(), clock(), customers(), dispatch(), gate() (+12 more)
...
## Knowledge Gaps
- **1579 isolated node(s):** `session-start.sh script`, `$schema`, `name`, `name`, `url` (+1574 more)
...
- **Should `Unit Audit Ledger` be split into smaller, more focused modules?**
  _Cohesion score 0.02189923425840121 - nodes in this community are weakly interconnected._
