...
const SUITES = [
  ...
  'unit/tenant-model-policy.test.js',
  'unit/approval-inbox-ui.test.js',
  'unit/governance-guarantees.test.js',
  'unit/workforce-registry.test.js',
  ...
  'unit/ads-provenance-link.test.js',
  'unit/ads-datamanager-client.test.js',
  'unit/ads-diagnostics.test.js',
  ...
  'unit/copilot-remote-adapter.test.js',
  'unit/copilot-telemetry.test.js',
  'unit/copilot-chat-bridge.test.js',
  'unit/copilot-eval-gate.test.js',
  'unit/copilot.test.js',
  'unit/sms-copilot.test.js',
  'unit/chat-canvas.test.js',
  'unit/field-mode.test.js',
  'unit/measurement-precision.test.js',
  'unit/manual-measure-ui.test.js',
  ...
  'unit/decision-inbox-ui.test.js',
  'unit/decision-bundle-ui.test.js',
